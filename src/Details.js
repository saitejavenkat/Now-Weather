    ...
    useEffect(() => {
      const inter=setTimeout(()=>{
        switch (data_get?.weather[0]?.main) {
          ...
          case 'Clouds':
            setSrc(!(time.hours >= 18 || time.hours < 6)
              ? { vid_link: "https://videos.pexels.com/video-files/5598970/5598970-uhd_2560_1440_24fps.mp4", img_link: "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/CloudyV3.svg" }
              : { vid_link: "https://videos.pexels.com/video-files/6601416/6601416-sd_640_360_30fps.mp4", img_link: "https://assets.msn.com/weathermapdata/1/static/weather/Icons/taskbar_v10/Condition_Card/PartlyCloudyNightV2.svg" });
            break;
          case 'Haze':
            setSrc(!(time.hours >= 18 || time.hours < 6)
      ...
      <>
            ...
            { srcLink.vid_link&&(
             ...
             <div className='city-heading'>
                ...
                <header>
                  <sub>
                { srcLink.img_link&&(<img src={srcLink.img_link}/>)}
                </sub>
                  {data_get?.name}
              ...
              <div className='weather-re'>
                <div className='current-weather'>
                  <header className="heading">Location Name:</header>
                  <span>&nbsp; {data_get?.name}</span>
                  <br/>
                  ...
                  <span>&nbsp;{time.day}-{time.month}-{time.year}, {days[time.day]}</span>
                  <br/>
                </div>     
